...
| marital status | VARCHAR(50)   | The marital status of the customer (e.g., 'Married', 'Single'). |
...
| maintenance_required | VARCHAR(50) | Indicates weather the product requires maintenance (e.g., 'Yes', 'No'). |
